...
public class MemberManageController extends BaseController{
	...
	@RequestMapping(value="/userDetailSave")
	public void userDetailSave(@RequestParam(value="loginName")String loginName, @ModelAttribute UserDetail userDetail,HttpServletRequest request,HttpServletResponse response) throws IOException{
		...
		if(flag){
			...
			int i=userService.userDetailSave(loginName,userDetail);
				if(i==1){
