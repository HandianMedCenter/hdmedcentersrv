...
public class Const {
	...
	// 万方密码
	public static final String WF_PASSWORD = "handian001";
	// 万方Token
	public static final String WF_TOKEN = "Handian";
	// 万方Key
	public static final String WF_KEY = "handian201508030";
	// 万方URL
	...
	public static final String NO_INTERCEPTOR_PATH_MANAGE = ".*/((manage/login)|(manage/logout)|(manage/index)|(file_upload)).*";	//不对匹配该值的访问路径拦截（正则）後台
	public static final String NO_INTERCEPTOR_PATH_client = ".*/((about)|(secret)|(index)|(registerUI)|(existence)|" +
			"(register)|(code_check)|(code)|(login)|(password)|(password)|(upload/cfile)|(redirect)|" +
