        ...
        <tbody>
        	<c:forEach var="us" items="${page.results }" varStatus="i">
	            <tr class="bodytr">
	                ...
	                <td>
                   	<c:forEach items="${areaProvs }" var="areaProv">
                   		${areaProv.provName==us.province?areaProv.provName:'' }
                   	</c:forEach>
                    </td>
                    <td>
                    <c:forEach items="${hospitalProfessionalList }" var="professional">
	                ...
	                <td width="185">
	                <a href="/mm/memberDetail.im?userDetailId=${us.id }" class="btn btn-green" data-toggle="dialog" data-mask="true" data-title="新增" data-width="800" data-height="500" data-icon="edit">详细</a>
