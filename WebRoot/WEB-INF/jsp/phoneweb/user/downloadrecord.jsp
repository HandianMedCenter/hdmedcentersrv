	                	...
	                	<div class="f_sc_list">
	                        ...
	                        <div class="f_sc_time">
	                        	...
	                        	<span style=" float:right;">
	                        		...
	                        		<a id="dld${rs.id }" <c:if test="${rs.isDownload == 0 }">onclick="upstatus(${rs.id });"</c:if> style="margin-right:25px;" target="_blank" href="${rs.literature.downloadUrl }">
						...
						if(types==1){
							for (var i=0; i<data.length; i++) {
				                  ...
				                  if(data[i].isDownload == 1){
				                  		content+="       		<a id=\"dld"+data[i].id+"\" style=\"margin-right:25px;\" target=\"_blank\" href=\""+data[i].literature.downloadUrl+"\"> ";
				                  }else{
				                  		content+="       		<a id=\"dld"+data[i].id+"\" onclick=\"upstatus("+data[i].id+");\" style=\"margin-right:25px;\" target=\"_blank\" href=\""+data[i].literature.downloadUrl+"\"> ";
